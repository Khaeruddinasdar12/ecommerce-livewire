...
<div id="accordion">
 ...
 <img src="{{asset('asdar.jpg')}}" class="img-thumbnail" alt="..." width="200" height="200">
   ...
   <div class="col-8">
      <p class="text-justify">Owner atau pemilik sekaligus pengelolah aplikasi toko online ini bernama Khaeruddin Asdar, 
      Seorang mahasiswa Stmik Dipanegara Makassar semester 6 pada jurusan Teknik Informatika. Stambuk/NIM 172296. 
      </p>
      <p class="text-justify">Saya juga senang dengan pemrograman WEB, karya saya dalam bidang web bisa di lihat di akun 
        <a href="https://github.com/Khaeruddinasdar12">github.com/khaeruddinasdar12</a>. Saya membuat toko online ini dan 
        membuatnya open source agar dapat digunakan sebagaimana mestinya, source code aplikasi ini bisa di lihat <a href="https://github.com/Khaeruddinasdar12/ecommerce-livewire">disini.</a>
      </p>
