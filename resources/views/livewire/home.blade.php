              ...
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group" >
                      <a href="{{route('detail', ['id' => $datas->id])}}" title="Lihat detail"><button type="button" class="btn btn-sm btn-outline-info"><i class="nav-icon fas fa-eye"></i> Detail</button></a>
                      <button wire:click="addToCart({{$datas->id}})" class="btn btn-sm btn-outline-success" title="Tambahkan ke keranjang" {{$disable}}><i class="nav-icon fas fa-shopping-cart"></i> Keranjang</button>
                    </div>
                  </div>
                </div>
              </div>
